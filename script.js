...
function notify_open(notifyorder,openclose){
	...
	if(openclose === "open"){
		simplyfy("notify").style.visibility = "visible";simplyfy("main_lay").style.opacity = "0.3"; simplyfy("main_header").style.opacity = "0.3";simplyfy("main_header").style.pointerEvents="none";
	}
	if(openclose === "close"){
		simplyfy("notify").style.visibility = "hidden";simplyfy("main_lay").style.opacity = "1";simplyfy("main_header").style.opacity = "1";simplyfy("main_header").style.pointerEvents="auto";
	}
}
